...
const BROKERS = {
  ...
  // Hyperliquid DEX: orderbook on-chain, taker 0.045%, maker 0.015%
  // Spread tight (orderbook profondo), no commission flat. Funding rate variabile gestito altrove.
  hyperliquid: {
    commissionPerLotPerSide: 0,
    feePctMaker: 0.00015,           // 0.015%
    feePctTaker: 0.00045,           // 0.045%
    spreads: {
      BTCUSDC: 0.5, BTCUSD: 0.5,
      ETHUSDC: 0.04, ETHUSD: 0.04,
      SOLUSDC: 0.003, SOLUSD: 0.003,
      XRPUSDC: 0.0001, XRPUSD: 0.0001,
      BNBUSDC: 0.05, BNBUSD: 0.05,
      HYPEUSDC: 0.005, HYPEUSD: 0.005,
      'USDT-USDC': 0.0001,
    },
    slippageAtrPct: 0.008,          // tight orderbook DEX
  },
